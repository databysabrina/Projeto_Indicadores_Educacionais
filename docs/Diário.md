...
---
#### 📅 Etapa 1: Definição de Objetivos e Escopo do Projeto
Antes de iniciar qualquer script, o foco foi estabelecer a "espinha dorsal" do projeto, definindo o que precisava ser resolvido e como a solução seria organizada. 

**1.1 Objetivos Estratégicos** O desafio central transformar dados brutos de uma Avaliação Externa em informações acionáveis para a gestão escolar, consolidando bases de dados fragmentadas para responder a três perguntas críticas de negócio:
  * *Quem são os alunos em risco?* (Identificação via critérios de idade, proficiência e aproveitamento).
...
Organizei o fluxo de trabalho utilizando ferramentas relacionadas, para garantir evolução do processo e da aprendizagem:
  ...
  * *Power BI:* Ferramenta de modelagem e visualização de dados.
...
Para garantir a transparência, estruturei os documentos que guiarão o desenvolvimento:
  ...
  * *Dicionário de Dados:* Mapeamento de tipos de dados e definições para evitar ambiguidades técnicas.
  * *Regras de Negócio:* Definição das premissas antes da execução dos scripts.

---
#### 📅 Etapa 2: Diagnóstico e Validação Inicial
O projeto foi iniciado com o desafio de consolidar as bases de dados de uma Avaliação Externa. Primeiramente, realizei um Diagnóstico de Integridade via SQL (PostgreSQL) para mapear a qualidade e identificar inconsistências técnicas que poderiam comprometer os indicadores nas próximas etapas.
...
---
#### 📅 Etapa 3: Limpeza e Tratamento de Dados (ETL)
